from Algorithm import ErdosRengy, Malla, Gilbert, Geo, Barabási, DorogovtsevMendes, BFS, DFS, Dijkstra
...
def switch2(op, Grafo, n, mode):
    'Pide los parametro y manda a llamar a los algoritmos BFS, DFS o Dijkstra'
    if op == 1:
        BFS(Grafo, n, mode)
        dfsybfs(Grafo, n, mode)
    elif op == 2:
